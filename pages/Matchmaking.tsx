  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your community profile has been created. We'll start connecting you with like-minded people.",
      });
        ...
        <section className="section-container">
          <div className="max-w-4xl mx-auto mb-16">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                Join our inclusive community platform designed to help differently-abled individuals build meaningful connections, friendships, and support networks.
              </p>
            </motion.div>
          </div>
          ...
          <Tabs defaultValue="about" className="max-w-4xl mx-auto" value={activeTab} onValueChange={handleTabChange}>
            <TabsList className="grid w-full grid-cols-3 mb-8">
              <TabsTrigger value="about">About Community</TabsTrigger>
              <TabsTrigger value="create">Join Community</TabsTrigger>
              <TabsTrigger value="success">Community Stories</TabsTrigger>
            </TabsList>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Share your interests, hobbies, and what you're looking for in connections.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Our platform helps you find people with similar interests and experiences.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <h3 className="font-medium">Safe Interactions</h3>
                        <p className="text-muted-foreground">Connect through our secure platform and participate in community events.</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Access resources, join group activities, and build lasting friendships.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground">Our platform respects Indian values and traditions while creating inclusive opportunities.</p>
                    </div>
                    <div>
                      <h3 className="font-medium flex items-center">
                        <Check className="h-4 w-4 text-green-500 mr-2" />
                      ...
                      <p className="text-muted-foreground">Connect with families who understand your experiences and challenges.</p>
                    </div>
                    <div>
                      <h3 className="font-medium flex items-center">
                        <Check className="h-4 w-4 text-green-500 mr-2" />
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="md:w-3/4">
                        ...
                        <p className="text-muted-foreground mb-4">
                          "With my hearing impairment, I found it difficult to meet someone through traditional channels. YuktiCare's matrimony platform connected me with Rahul, who understands me perfectly. We've been married for over a year now and couldn't be happier!"
                        </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="md:w-3/4">
                        ...
                        <p className="text-muted-foreground mb-4">
                          "After my accident left me with mobility challenges, I thought marriage wasn't in my future. Through YuktiCare, I met Meera who sees beyond my wheelchair. Our families connected well, and we had a beautiful wedding in Chennai last month."
                        </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="md:w-3/4">
                        ...
                        <p className="text-muted-foreground mb-4">
                          "Living with visual impairment, I was hesitant about marriage websites. YuktiCare's inclusive platform made it easy to connect with Deepak, who values me for who I am. We're now planning our wedding for next Diwali!"
                        </p>
